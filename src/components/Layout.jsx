...
function Layout() {
  ...
  return (
    ...
    className="min-h-screen text-white font-sans antialiased flex flex-col">
      {/* Header */}
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-3 sm:pt-4">
        <Header setShowModal={setShowModal} />
      </div>
      {/* Main content */}
      <div className="flex-1 flex items-center justify-center w-full max-w-7xl mx-auto px-4 sm:px-6 pb-4 sm:pb-6">
        <Outlet />
      </div>
